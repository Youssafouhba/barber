...
import com.halaq.backend.core.util.AuditEntityUtil;
import com.halaq.backend.core.util.BooleanUtil;
import com.halaq.backend.core.util.DateUtil;
import com.halaq.backend.core.audit.AuditEntity;
import com.halaq.backend.core.audit.Log;
import com.halaq.backend.core.dto.BaseDto;
import com.halaq.backend.core.entity.BusinessObject;
import com.halaq.backend.core.entity.EnumBean;
import com.halaq.backend.core.util.AuditEntityUtil;
import com.halaq.backend.core.util.BooleanUtil;
import com.halaq.backend.core.util.DateUtil;
...
public abstract class Utils {
    ...
    private static <T extends BaseDto> void handelTagAnnotaion(T newVal, T oldVal, List<AuditEntity> list, LocalDateTime d, Method method, Annotation tagAnnotation) throws NoSuchMethodException {
        if (tagAnnotation != null) {
            ...
            if (com.halaq.backend.core.util.BooleanUtil.isNotEquals(value1, value2)) {
                boolean collection = com.halaq.backend.core.util.BooleanUtil.isaBoolean(value1, value2);
                if (collection) {
                    com.halaq.backend.core.util.AuditEntityUtil.handlCollection(oldVal, list, d, method, value1, value2);
                } else {
