...
import com.halaq.backend.core.util.UniqueID;
import com.halaq.backend.core.util.DateUtil;
import com.halaq.backend.core.util.UniqueID;
...
public class FileUtils {
     ...
     */
    public static String generateUniqueFileName(Long barberId, String originalName) {
        String extension = originalName.substring(originalName.lastIndexOf("."));
        String timestamp = String.valueOf(System.currentTimeMillis());
        return String.format("barber_%d_%s%s", barberId, timestamp, extension);
    }
