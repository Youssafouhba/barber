package com.halaq.backend.core.controller;
...
import com.halaq.backend.core.dto.FileTempDto;
import com.halaq.backend.core.entity.BaseEntity;
import com.halaq.backend.core.exception.BusinessRuleException;
import com.halaq.backend.core.exception.GlobalException;
import com.halaq.backend.core.export.ExportModel;
...
*/
    ...
    @ExceptionHandler
    public ResponseEntity<com.halaq.backend.core.controller.ErrorResponse> exceptionHandler(Exception e, HttpServletRequest request) throws IOException {
        GlobalException globalException = new GlobalException(e, messageSource, request.getRequestURI());
        com.halaq.backend.core.controller.ErrorResponse errorResponse = new ErrorResponse(globalException.getStatus(), e, globalException.getMessage(), request.getRequestURI());
